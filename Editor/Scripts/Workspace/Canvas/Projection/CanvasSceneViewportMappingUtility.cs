...
{
    internal static class CanvasSceneViewportMappingUtility
    {
            ...
            out Rect viewportRect)
        {
            ...
            if (!TryGetSceneViewportMapping(
                    ...
                    framePadding,
                    frameHeaderHeight,
                    out CanvasSceneViewportMapping mapping))
            {
                return false;
            }
        ...
        {
            mapping = default;
            if (!CanvasViewportFrameLayoutCalculator.TryGetFrameContentLayout(
                    viewportState,
                    projectionSceneRect,
                    preserveAspectRatioMode,
                    framePadding,
            ...
            mapping = new CanvasSceneViewportMapping(projectionSceneRect, layout, scale);
            return true;
        }
