...
namespace SvgEditor.Workspace.Canvas
{
    internal sealed class CanvasOverlayController
    {
        ...
        private readonly CanvasDefinitionOverlayPresenter _definitionOverlayPresenter = new();
        private readonly CanvasSelectionChromePresenter _selectionChromePresenter = new();
        ...
        public void Attach(VisualElement host, VisualElement frameElement)
        {
            ...
            _overlay.AddClass(CanvasOverlayClassName.OVERLAY);
            _overlay.pickingMode = PickingMode.Position;
            host.Add(_overlay);

            _frameLabel = new Label();
            _frameLabel.AddClass(CanvasOverlayClassName.FRAME_LABEL);
            _frameLabel.pickingMode = PickingMode.Position;
            _overlay.Add(_frameLabel);

            _selectionChromePresenter.BindBackdrop(_overlay);

            _maskBoundsBox = CreateDefinitionBoundsBox(CanvasOverlayClassName.DEFINITION_BOUNDS_MASK);
            _clipBoundsBox = CreateDefinitionBoundsBox(CanvasOverlayClassName.DEFINITION_BOUNDS_CLIP);
        ...
        {
            return _selectionChromePresenter.TryHitTestHandle(localPoint, out handle);
        }
        ...
        private VisualElement CreateDefinitionBoundsBox(string modifierClass)
        {
            ...
            element.AddClass(CanvasOverlayClassName.DEFINITION_BOUNDS);
        ...
        {
            var element = new CanvasPolylineOverlayElement();
            _overlay.Add(element);
            return element;
        }
    }
