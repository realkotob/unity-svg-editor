...
{
    internal sealed class DefinitionProxyCoordinator
    {
        private readonly DefinitionOverlayBuilder _definitionOverlayBuilder = new();
        ...
        private static bool IsLiveDraggedPreviewReady(PointerDragController pointerDragController, Rect liveViewportRect)
        {
